...
test.describe("RFC Address Detection", () => {
  ...
  test("should identify RFC1918 private addresses in Type column", async ({
    page,
  }) => {
  ...
  test("should identify RFC6598 shared addresses in Type column", async ({
    page,
  }) => {
  ...
  test("should maintain RFC styling when splitting subnets", async ({
    page,
  }) => {
